 ...
 */
final class Version20190802181038 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD partenaire_id INT NOT NULL, ADD profile_id INT NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user DROP partenaire_id, DROP profile_id');
    }
}
